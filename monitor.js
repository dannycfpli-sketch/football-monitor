...
// ---------------------------------------------------------------------------
// 聯賽名稱對照表（FotMob leagueId → 繁體中文）
// 資料源比賽數據僅含 leagueId，不含聯賽名稱；此表用於已知主流聯賽的翻譯。
// 未收錄的 leagueId（多為小眾低級別聯賽之內部新 ID）無法識別，將省略聯賽欄位。
// ---------------------------------------------------------------------------
const LEAGUE_ZH = {
  // === 五大聯賽 ===
  47: '英超', 53: '法甲', 54: '德甲', 55: '意甲', 87: '西甲',
  // === 英格蘭各級 ===
  48: '英冠', 108: '英甲', 109: '英乙', 117: '英格蘭全國聯', 64: '蘇超',
  // === 歐戰 ===
  42: '歐冠', 73: '歐霸', 10216: '歐協聯',
  // === 主要歐洲聯賽 ===
  57: '荷甲', 46: '丹麥超', 51: '芬超', 68: '瑞典超', 135: '希臘超',
  196: '波蘭超', 204: '挪超', 140: '西乙', 86: '意乙', 215: '冰島超',
  130: '美職聯', 230: '墨超',
  // === 亞洲 ===
  113: '澳超', 127: '以色列超', 128: '以色列乙', 290: '亞洲盃',
  525: '亞冠精英', 526: '非冠',
  // === 國際賽事 ===
  77: '世界盃', 50: '歐洲盃', 44: '美洲盃', 289: '非洲盃',
  45: '解放者盃', 299: '南美盃', 78: '世俱盃',
  9806: '歐國聯A', 9807: '歐國聯B', 9808: '歐國聯C', 9809: '歐國聯D',
  // === 主要盃賽 ===
  132: '足總盃', 138: '國王盃', 141: '意大利盃', 209: '德國盃',
  137: '蘇格蘭盃', 224: '日聯盃', 151: '土耳其盃', 190: '羅馬尼亞盃', 193: '俄羅斯盃',
};

function leagueName(leagueId) {
  return LEAGUE_ZH[leagueId] || null;
}
...
async function main() {
  ...
  for (const m of fresh) {
    ...
    const lg = leagueName(m.leagueId);
